    ...
    <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
      <header style={{ marginBottom: '2.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
        <div>
          ...
          <p>Visualizations and executive summary.</p>
        </div>
      ...
      {figures.length === 0 ? (
        <div className="card"><p style={{ color: 'var(--text-muted)' }}>No figures yet. Run Phase 5 (Visualization).</p></div>
      ) : (
            ...
            <div key={i} className="card" style={{ padding: 0, overflow: 'hidden' }}>
              ...
              <div style={{ padding: '1.5rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  ...
                  <button className="btn btn-outline" style={{ padding: '0.5rem' }} onClick={() => window.open(`/figures/${activeProject.id}/${fig.filename}`, '_blank')}>
